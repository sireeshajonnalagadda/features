...
```json
"features": {
    "ghcr.io/sireeshajonnalagadda/features/git:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/sireeshajonnalagadda/features/blob/main/src/git/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
