...
```json
"features": {
    "ghcr.io/sireeshajonnalagadda/features/github-cli:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/sireeshajonnalagadda/features/blob/main/src/github-cli/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
