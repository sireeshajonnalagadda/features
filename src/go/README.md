...
```json
"features": {
    "ghcr.io/sireeshajonnalagadda/features/go:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/sireeshajonnalagadda/features/blob/main/src/go/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
